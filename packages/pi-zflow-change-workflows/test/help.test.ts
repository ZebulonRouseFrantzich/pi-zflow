/**
 * help.test.ts — Validates that pi-zflow-change-workflows exports help topic metadata
 * with namespaced commands.
 */
import * as assert from "node:assert"
import { test, describe } from "node:test"
import { ZFLOW_HELP_TOPICS } from "../src/index.js"

describe("pi-zflow-change-workflows help topics", () => {
