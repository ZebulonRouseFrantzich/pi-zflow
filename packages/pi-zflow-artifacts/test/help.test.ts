/**
 * help.test.ts — Validates that pi-zflow-artifacts exports help topic metadata
 * with namespaced commands/tools.
 */
import * as assert from "node:assert"
import { test, describe } from "node:test"
import { ZFLOW_HELP_TOPICS } from "../src/index.js"

describe("pi-zflow-artifacts help topics", () => {
  test("exports at least one help topic", () => {
    assert.ok(ZFLOW_HELP_TOPICS.length >= 1)
  })

  test("all command/tool names are namespaced (zflow-* or zflow_*)", () => {
