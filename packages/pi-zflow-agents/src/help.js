 ...
 */
export const AGENTS_HELP_TOPIC = {
    packageName: "pi-zflow-agents",
    id: "agents",
    title: "Agent Setup",
    summary: "Install or update custom agent markdown, chains, skills, and " +
        "prompt templates for subagent workflows.",
    flowOrder: 15,
    flowGuidance: "Run after profile configuration to ensure custom agents and " +
    ...
    commands: [
        {
            ...
            description: "Install pi-zflow custom agents, chains, and prompt templates.",
        },
        {
            name: "zflow-update-agents",
            usage: "/zflow-update-agents",
            description: "Update previously installed agents and chains to the " +
                "latest versions.",
        },
    ],
 ...
 */
export const ZFLOW_HELP_TOPICS = [AGENTS_HELP_TOPIC];
